...
// !PING
			...
			if( Command == "sheep" || Command == "rio" || Command == "stu" || Command == "ich" || Command == "one" || Command == "duke" || Command == "tom" || Command == "mosy" || Command == "dude" || Command == "luls")
			{
				if(Command == "rio"){
					SendAllChat("Rio is the boss");
				}
				if(Command == "sheep"){
					SendAllChat("Don't eat frogs - will damage your brain --> see sheep");
				}
				if(Command == "luls"){
					SendAllChat("... loves KTM");
				}
				if(Command == "dude"){
					SendAllChat("Ciao Dude - pizza ready?");
				}
			
				if(Command == "mosy"){
					SendAllChat("Mosy afk buying weed!");
				}
			
				if(Command == "tom"){
					SendAllChat("Tom kills Jerry");
				}
				else if(Command == "stu"){
